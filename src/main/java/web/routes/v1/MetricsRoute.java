package repbot.web.routes.v1;

import repbot.web.routes.RoutesBuilder;
import repbot.web.routes.v1.metrics.Commands;
import repbot.web.routes.v1.metrics.Messages;
import repbot.web.routes.v1.metrics.MetricCache;
import repbot.web.routes.v1.metrics.Reputation;
import repbot.web.routes.v1.metrics.Service;
import repbot.web.routes.v1.metrics.Users;
...
public class MetricsRoute implements RoutesBuilder {
    ...
    public MetricsRoute(repbot.dao.provider.Metrics metrics) {
