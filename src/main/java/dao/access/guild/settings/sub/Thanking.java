package repbot.dao.access.guild.settings.sub;

import repbot.dao.access.guild.settings.Settings;
import repbot.dao.access.guild.settings.sub.thanking.Channels;
import repbot.dao.access.guild.settings.sub.thanking.DonorRoles;
import repbot.dao.access.guild.settings.sub.thanking.Reactions;
import repbot.dao.access.guild.settings.sub.thanking.ReceiverRoles;
import repbot.dao.access.guild.settings.sub.thanking.Thankwords;
import repbot.dao.components.GuildHolder;
import sadu.base.QueryFactory;
import sadu.wrapper.util.Row;
