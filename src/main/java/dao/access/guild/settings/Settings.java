package repbot.dao.access.guild.settings;

import repbot.dao.access.guild.RepGuild;
import repbot.dao.access.guild.settings.sub.AbuseProtection;
import repbot.dao.access.guild.settings.sub.General;
import repbot.dao.access.guild.settings.sub.Messages;
import repbot.dao.access.guild.settings.sub.Ranks;
import repbot.dao.access.guild.settings.sub.Reputation;
import repbot.dao.access.guild.settings.sub.Thanking;
import repbot.dao.components.GuildHolder;
import repbot.dao.pagination.Announcements;
