...
import jdautil.interactions.dispatching.InteractionHub;
import repbot.analyzer.ContextResolver;
import repbot.analyzer.MessageAnalyzer;
import repbot.commands.abuseprotection.AbuseProtection;
import repbot.commands.bot.BotAdmin;
import repbot.commands.channel.Channel;
import repbot.commands.dashboard.Dashboard;
import repbot.commands.debug.Debug;
import repbot.commands.gdpr.Gdpr;
import repbot.commands.info.Info;
import repbot.commands.invite.Invite;
import repbot.commands.locale.Locale;
import repbot.commands.log.Log;
import repbot.commands.messages.Messages;
import repbot.commands.prune.Prune;
import repbot.commands.reactions.Reactions;
import repbot.commands.repadmin.RepAdmin;
import repbot.commands.repsettings.RepSettings;
import repbot.commands.reputation.Reputation;
import repbot.commands.roles.Roles;
import repbot.commands.scan.Scan;
import repbot.commands.setup.Setup;
import repbot.commands.thankwords.Thankwords;
import repbot.commands.top.Top;
import repbot.config.Configuration;
import repbot.listener.LogListener;
import repbot.listener.MessageListener;
import repbot.listener.ReactionListener;
import repbot.listener.StateListener;
import repbot.listener.VoiceStateListener;
import repbot.listener.voting.ReputationVoteListener;
import repbot.service.AnalyzerService;
import repbot.service.GdprService;
import repbot.service.MetricService;
import repbot.service.PresenceService;
import repbot.service.RepBotCachePolicy;
import repbot.service.ReputationService;
import repbot.service.RoleAssigner;
import repbot.service.RoleUpdater;
import repbot.service.SelfCleanupService;
